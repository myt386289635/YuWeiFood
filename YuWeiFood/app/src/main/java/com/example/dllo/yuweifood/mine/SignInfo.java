...
public class SignInfo {
    ...
    public SignInfo(String title, Fragment f) {
        this.title = title;
        this.f = f;
    }
    ...
    public static List<SignInfo> getTabInfors(){
        List<SignInfo> infos = new ArrayList<>();
        infos.add(new SignInfo("注册", new RegisterFragment()));
        infos.add(new SignInfo("登录",new LoginFragment()));
