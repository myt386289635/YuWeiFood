package com.example.dllo.yuweifood.recommend.headviewpager;         /*
                                MMMMM
                                  MMMMMM
                                    MMMMMMM
                                     MMMMMMMM     .
...
public class ViewHeadAdapter extends RecyclerView.Adapter<ViewHolder>{
    ...
    public ViewHeadAdapter(Context context, ViewPagerHeadBean viewPagerHeadBean){
    ...
    public int getItemCount() {
        return viewPagerHeadBean.getData().getContent().size();
    }
    private class TextHolder extends ViewHolder{
        ...
        public TextHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.item_recom_text);
        }
    }
    private class ImgHolder extends ViewHolder{
        ImageView imageView;

        public ImgHolder(View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.item_recom_img);
        }
    }
}
